...
sec = pg.image.load("/Users/ayaulymnurtaza/Downloads/lab7/leftarm.png").convert_alpha()
minute = pg.image.load("/Users/ayaulymnurtaza/Downloads/lab7/rightarm.png").convert_alpha()
rectsec = sec.get_rect()
rectmin = minute.get_rect()
rectmin.center = rectsec.center = midle

background = pg.image.load("/Users/ayaulymnurtaza/Downloads/lab7/mainclock 2.jpeg")
run =True
