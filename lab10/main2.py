...
class SNAKE:
    def __init__(self):
        ...
        self.head_up = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/head_up.png').convert_alpha()
        self.head_down = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/head_down.png').convert_alpha()
        self.head_right = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/head_right.png').convert_alpha()
        self.head_left = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/head_left.png').convert_alpha()
		
        self.tail_up = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/tail_up.png').convert_alpha()
        self.tail_down = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/tail_down.png').convert_alpha()
        self.tail_right = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/tail_right.png').convert_alpha()
        self.tail_left = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/tail_left.png').convert_alpha()

        self.body_vertical = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/body_vertical.png').convert_alpha()
        self.body_horizontal = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/body_horizontal.png').convert_alpha()

        self.body_tr = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/body_tr.png').convert_alpha()
        self.body_tl = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/body_tl.png').convert_alpha()
        self.body_br = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/body_br.png').convert_alpha()
        self.body_bl = pg.image.load('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/body_bl.png').convert_alpha()
...
class MAIN:
    def __init__(self):
        ...
        self.fruit=FRUIT()
        self.dead=False
        self.dead_sound = pg.mixer.Sound('/Users/bahauddin/Coding/pp2-22B030598/tsis10/snake 2.0/se_dead.mp3')
